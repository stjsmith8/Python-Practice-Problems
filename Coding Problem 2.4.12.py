...
my_string = "The sum is {0}, the difference is {1}, the product is {2}, and the quotient is {3}.".format(mystery_value_1 + mystery_value_2, mystery_value_1 - mystery_value_2, mystery_value_1 * mystery_value_2, mystery_value_1 / mystery_value_2)
