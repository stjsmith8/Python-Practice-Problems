...
go_to_class2=(not exam and sunny) and ((sunblock and morning_classes) or (night_classes))

go_to_class3=(not exam and raining and rain_jacket)

go_to_class4=(not exam and snowing) and ((friends_are_going and fluffy_coat) or (really_want_to_go))

result=go_to_class1 or go_to_class2 or go_to_class3 or go_to_class4
